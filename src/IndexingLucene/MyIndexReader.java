...
public class MyIndexReader {
	...
	public MyIndexReader(String type) throws IOException {
		...
		else if(type=="Hq"){//query history
			directory = FSDirectory.open(Paths.get(Classes.Path.IndexDir_Hq));
		}
		else{//clickthrow history
			directory = FSDirectory.open(Paths.get(Classes.Path.IndexDir_Hc));
		}
